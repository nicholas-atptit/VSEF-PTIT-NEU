...
The system successfully implements a governed, reproducible experiment framework for stock forecasting research. However, the empirical evidence does not support a universal ML-model superiority claim. Baselines remain highly competitive, risk-aware ranking does not improve aggregate utility, and the strongest contribution is the regime-aware analysis showing that model and risk-layer behavior depend on market conditions.
