...
This supervisor-facing limitations file explains how the evidence should be interpreted. The limitations do not invalidate the project. They constrain the final claim.
...
## 8. What These Limitations Mean for the Final Claim

These limitations do not invalidate the project. They constrain the claim. The correct claim is not that VSEF predicts stocks better than all baselines, but that VSEF creates a governed and reproducible framework for evaluating forecasting, risk, and regime-dependent behavior.
