...
- `build_vn30_2015_benchmark_readiness_manifest.py` - referenced by `reports/protocols/VN30_HOURLY_2015_DATA_READINESS_PLAN.md`; keep until the readiness-doc dependency is clarified.
