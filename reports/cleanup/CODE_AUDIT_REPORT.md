...
Changes not staged for commit:
  modified:   reports/superseded/risk_tuning_report.md
  modified:   reports/superseded/stress_test_report.md
  modified:   reports/superseded/system_benchmark.md
...
- `reports/superseded/risk_tuning_report.md` was modified by test execution.
- `reports/superseded/stress_test_report.md` was modified by test execution.
- `reports/superseded/system_benchmark.md` was modified by test execution.
...
- Severity: HIGH
- Affected files: `reports/superseded/risk_tuning_report.md`, `reports/superseded/stress_test_report.md`, `reports/superseded/system_benchmark.md`, related tests under `tests/ml/`
...
- Operational impact: future maintainers may be unsure whether `reports/cleanup/CODE_AUDIT_REPORT.md` is canonical or historical.
...
| Git status after tests | Modified `reports/superseded/risk_tuning_report.md`, `reports/superseded/stress_test_report.md`, `reports/superseded/system_benchmark.md`; untracked `reports/cleanup/CODE_AUDIT_REPORT.md`. |
