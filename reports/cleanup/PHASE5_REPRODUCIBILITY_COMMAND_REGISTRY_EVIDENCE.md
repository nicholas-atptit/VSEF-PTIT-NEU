...
- `reports/cleanup/AUDIT_REMEDIATION_CHECKLIST.md` and Phase 2/3/4A/4/5 evidence files are controlled remediation records.
...
- `reports/results/RESEARCH_TOPIC_AND_CODE_AUDIT_REPORT.md` remains intentionally untracked and untouched.
