...
|---|---|---|---|---|
| `scripts/research/build_vn30_2015_benchmark_readiness_manifest.py` | keep_manual_review | kept | Filename and module referenced by `reports/protocols/VN30_HOURLY_2015_DATA_READINESS_PLAN.md`. | Readiness-plan dependency; keep until the 2015 hourly readiness docs are superseded. |
