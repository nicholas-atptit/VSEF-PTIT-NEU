...
| Repository hygiene and reproducibility baseline | [reports/CODE_AUDIT_REPORT.md](reports/CODE_AUDIT_REPORT.md), committed `__pycache__`, `outputs/`, `artifacts/`, `models/` | Verified by committed report/artifact | High | High | Must be described honestly as a weakness. |
...
- Existing baseline report at [reports/CODE_AUDIT_REPORT.md](reports/CODE_AUDIT_REPORT.md).
