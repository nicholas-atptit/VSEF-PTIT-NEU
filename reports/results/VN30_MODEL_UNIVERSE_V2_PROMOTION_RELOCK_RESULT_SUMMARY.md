...
5. Did any relocked direction candidate beat 61.61% on comparable scope: false for `direction__hist_gradient_boosting__absolute_direction__h40__relative_strength` with final accuracy 55.14%; this is not a replacement claim.
6. Did any relocked market-relative candidate beat 64.44% on comparable scope: false for `direction__simple_relative_strength__market_relative_vn30__h40__all_safe_features` with final accuracy 53.29%; this is not a QML replacement claim.
7. Did any relocked price/return candidate beat random walk/last price on final: false for `price__simple_relative_strength__market_excess_return_h__h20__compact_stable_features` with final RMSE improvement -0.76 pp.
