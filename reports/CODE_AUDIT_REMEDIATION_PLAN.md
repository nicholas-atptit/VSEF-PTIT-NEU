...
- Every remediation item must map to a finding ID in `reports/CODE_AUDIT_REPORT.md`.
...
| Files/modules affected | `pyproject.toml`, `requirements.txt`, `src/risk/garch.py`, `tests/phase2/test_garch_risk.py`, `tests/ml/*benchmark*`, `reports/risk_tuning_report.md`, `reports/stress_test_report.md`, `reports/system_benchmark.md`, `.pytest_cache` handling. |
