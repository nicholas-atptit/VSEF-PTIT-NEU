...
- `reports/CODE_AUDIT_REMEDIATION_PLAN.md`
- `docs/archive/`
- `docs/audits/`
- `docs/experiments/`
- `docs/reports/`
...
- `reports/risk_aware/`
- `reports/VSEF_1000_SEED_SMOKE_STABILITY_REPORT.md`
...
- `reports/RESEARCH_TOPIC_AND_CODE_AUDIT_REPORT.md` remains untracked and was not touched.
