...
| `HDB` | `confirmed_listing_date` | 2018-01-05 | `user_provided` | true |
| `HPG` | `confirmed_listing_date` | 2007-11-15 | `user_provided` | true |
| `LPB` | `confirmed_listing_date` | 2017-10-05 | `user_provided` | true |
| `MBB` | `confirmed_listing_date` | 2011-11-01 | `user_provided` | true |
| `MSN` | `confirmed_listing_date` | 2009-11-05 | `user_provided` | true |
| `MWG` | `confirmed_listing_date` | 2014-07-14 | `user_provided` | true |
| `PLX` | `confirmed_listing_date` | 2017-04-21 | `user_provided` | true |
| `SAB` | `confirmed_listing_date` | 2016-12-06 | `user_provided` | true |
| `SHB` | `confirmed_listing_date` | 2009-04-20 | `user_provided` | true |
| `SSB` | `confirmed_listing_date` | 2021-03-24 | `user_provided` | true |
| `SSI` | `confirmed_listing_date` | 2006-12-15 | `user_provided` | true |
| `STB` | `confirmed_listing_date` | 2006-07-12 | `user_provided` | true |
| `TCB` | `needs_verification` |  | `needs_verification` | true |
| `TPB` | `needs_verification` |  | `needs_verification` | true |
| `VCB` | `needs_verification` |  | `needs_verification` | true |
| `VHM` | `needs_verification` |  | `needs_verification` | true |
| `VIB` | `needs_verification` |  | `needs_verification` | true |
| `VIC` | `needs_verification` |  | `needs_verification` | true |
