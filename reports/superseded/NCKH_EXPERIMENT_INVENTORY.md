...
| Report | Use |
|---|---|
| `reports/superseded/WALK_FORWARD_BENCHMARKING_ENSEMBLE_BASELINE_MODELS_VN_STOCK_MARKET.md` | Current evidence-backed research narrative for VN100 walk-forward benchmark. |
| `reports/superseded/VN100_HYBRID_BENCHMARK_CLOSEOUT.md` | Closeout summary of official 2025 train-cutoff diagnostics and extended monitoring. |
| `reports/cleanup/PHASE6_STATISTICAL_ACCEPTANCE_EVIDENCE.md` | Acceptance-governance evidence. |
...
| `reports/superseded/NCKH_RESULTS_CLAIM_REGISTER.md` | Claim register separating safe, conditional, and unsafe result claims. |
...
| `reports/superseded/NCKH_EVIDENCE_GAP_CLOSURE_REGISTER.md` | Gap-by-gap closure status and claim-boundary impact. |
...
| Artifact | Use |
|---|---|
| `reports/superseded/NCKH_EVIDENCE_UPGRADE_ADDENDUM_V2.md` | Supervisor-readable addendum summarizing new evidence, remaining gaps, and Chapter 4 implications. |
...
| `reports/superseded/NCKH_RESULTS_CLAIM_REGISTER_V2.md` | Updated claim governance separating unchanged safe claims, new derived-diagnostic claims, upgraded conditional claims, and still-unsafe claims. |
