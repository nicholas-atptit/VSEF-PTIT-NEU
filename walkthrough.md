...
- **Module**: [feature_engineering.py](file:///h:/AI-ML-LLM%20in%20Stock_march26_PTIT_NEU/src/ml/feature_engineering.py)
...
- **Training Script**: [train_ml_tickers.py](file:///h:/AI-ML-LLM%20in%20Stock_march26_PTIT_NEU/scripts/train_ml_tickers.py)
...
- **Model Trainer**: [trainer.py](file:///h:/AI-ML-LLM%20in%20Stock_march26_PTIT_NEU/src/ml/trainer.py)
...
- **Data Loader**: [data_loader.py](file:///h:/AI-ML-LLM%20in%20Stock_march26_PTIT_NEU/src/ml/data_loader.py)
...
We verified the results using the high-fidelity [debug_compare_train_infer.py](file:///h:/AI-ML-LLM%20in%20Stock_march26_PTIT_NEU/scripts/debug_compare_train_infer.py) script.
...
- [feature_engineering.py](file:///h:/AI-ML-LLM%20in%20Stock_march26_PTIT_NEU/src/ml/feature_engineering.py) (Unified Core)
- [trainer.py](file:///h:/AI-ML-LLM%20in%20Stock_march26_PTIT_NEU/src/ml/trainer.py) (Inference Sync)
- [train_ml_tickers.py](file:///h:/AI-ML-LLM%20in%20Stock_march26_PTIT_NEU/scripts/train_ml_tickers.py) (Training Sync)
- [data_loader.py](file:///h:/AI-ML-LLM%20in%20Stock_march26_PTIT_NEU/src/ml/data_loader.py) (Lookback Stability)
- [debug_compare_train_infer.py](file:///h:/AI-ML-LLM%20in%20Stock_march26_PTIT_NEU/scripts/debug_compare_train_infer.py) (High-Fidelity Debug Tool)
