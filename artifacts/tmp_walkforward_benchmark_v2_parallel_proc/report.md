...
## Best Performers
- step_size=1: stacking overall RMSE=0.044855, MAE=0.034705, directional_accuracy=0.7500
- step_size=2: stacking overall RMSE=0.042135, MAE=0.033755, directional_accuracy=0.7778
...
- scope=overall_horizon, step_size=1, horizon=short_10d: stacking beat the field on RMSE in 66.67% of pairwise comparisons and on directional accuracy in 100.00%.
...
- scope=ticker, step_size=1, horizon=short_5d: stacking beat the field on RMSE in 83.33% of pairwise comparisons and on directional accuracy in 66.67%.
...
- scope=ticker, step_size=2, horizon=short_10d: stacking beat the field on RMSE in 66.67% of pairwise comparisons and on directional accuracy in 50.00%.
...
- scope=ticker, step_size=2, horizon=short_5d: stacking beat the field on RMSE in 83.33% of pairwise comparisons and on directional accuracy in 33.33%.

## Largest Divergences
- ACB short_10d step=1 prediction_date=2025-01-13: predicted=-0.085751, actual=0.026163, absolute_error=0.111914
- ACB short_10d step=1 prediction_date=2025-01-10: predicted=-0.083814, actual=0.013909, absolute_error=0.097723
- ACB short_10d step=2 prediction_date=2025-01-10: predicted=-0.083814, actual=0.013909, absolute_error=0.097723
- ACB short_10d step=1 prediction_date=2025-01-07: predicted=-0.079250, actual=0.008205, absolute_error=0.087454
- ACB short_10d step=1 prediction_date=2025-01-09: predicted=-0.080387, actual=-0.006223, absolute_error=0.074164
- ACB short_10d step=1 prediction_date=2025-01-08: predicted=-0.075743, actual=-0.001915, absolute_error=0.073829
- ACB short_10d step=2 prediction_date=2025-01-08: predicted=-0.075743, actual=-0.001915, absolute_error=0.073829
- ACB short_10d step=1 prediction_date=2025-01-06: predicted=-0.074499, actual=-0.005722, absolute_error=0.068776
- ACB short_10d step=2 prediction_date=2025-01-06: predicted=-0.074499, actual=-0.005722, absolute_error=0.068776
- ACB short_10d step=1 prediction_date=2025-01-03: predicted=-0.093157, actual=-0.029453, absolute_error=0.063704
...
## Output Bundle Paths
- csv_outputs.zip: `artifacts\tmp_walkforward_benchmark_v2_parallel_proc\csv_outputs.zip`
- charts_outputs.zip: `artifacts\tmp_walkforward_benchmark_v2_parallel_proc\charts_outputs.zip`
- report.md: `artifacts\tmp_walkforward_benchmark_v2_parallel_proc\report.md`
