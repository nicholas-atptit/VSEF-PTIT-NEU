...
## Best Performers
- step_size=1: stacking overall RMSE=0.059815, MAE=0.053698, directional_accuracy=0.6667
- step_size=2: stacking overall RMSE=0.056517, MAE=0.050477, directional_accuracy=0.7778
...
- step_size=1, horizon=short_10d: best RMSE model was `lightgbm` with RMSE=0.072854
...
- step_size=1, horizon=short_5d: best RMSE model was `cart` with RMSE=0.023795
...
- step_size=2, horizon=short_10d: best RMSE model was `lightgbm` with RMSE=0.068126
...
- step_size=2, horizon=short_5d: best RMSE model was `cart` with RMSE=0.019953
...
- scope=overall_horizon, step_size=1, horizon=short_10d: stacking beat the field on RMSE in 33.33% of pairwise comparisons and on directional accuracy in 0.00%.
...
- scope=overall_horizon, step_size=1, horizon=short_5d: stacking beat the field on RMSE in 66.67% of pairwise comparisons and on directional accuracy in 33.33%.
...
- scope=overall_horizon, step_size=2, horizon=short_10d: stacking beat the field on RMSE in 66.67% of pairwise comparisons and on directional accuracy in 0.00%.
...
- scope=overall_horizon, step_size=2, horizon=short_5d: stacking beat the field on RMSE in 66.67% of pairwise comparisons and on directional accuracy in 33.33%.
...
- scope=ticker, step_size=1, horizon=short_10d: stacking beat the field on RMSE in 33.33% of pairwise comparisons and on directional accuracy in 0.00%.
...
- scope=ticker, step_size=1, horizon=short_5d: stacking beat the field on RMSE in 66.67% of pairwise comparisons and on directional accuracy in 33.33%.
...
- scope=ticker, step_size=2, horizon=short_10d: stacking beat the field on RMSE in 66.67% of pairwise comparisons and on directional accuracy in 0.00%.
...
## Output Bundle Paths
- csv_outputs.zip: `artifacts\tmp_walkforward_benchmark_v2\csv_outputs.zip`
- charts_outputs.zip: `artifacts\tmp_walkforward_benchmark_v2\charts_outputs.zip`
- report.md: `artifacts\tmp_walkforward_benchmark_v2\report.md`
