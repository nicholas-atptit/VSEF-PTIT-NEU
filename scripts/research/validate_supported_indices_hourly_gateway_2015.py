"""Validate supported index hourly 2015 gateway cache files."""
...
REPORT_ROOT = REPO_ROOT / "reports" / "generated" / "index_hourly_2015" / "validation"
CSV_PATH = REPORT_ROOT / "index_hourly_2015_validation.csv"
MD_PATH = REPORT_ROOT / "index_hourly_2015_validation.md"
