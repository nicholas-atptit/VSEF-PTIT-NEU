"""Audit Final65 focus v3 results."""
...
BASELINE_DIR = REPO_ROOT / "outputs" / "vn30_hourly_2015_final65_focus_v3"
REPORT_DIR = REPO_ROOT / "reports" / "generated" / "vn30_hourly_2015_final65_focus_v3"
AUDIT_CSV_PATH = REPORT_DIR / "final65_focus_v3_audit.csv"
AUDIT_MD_PATH = REPORT_DIR / "final65_focus_v3_audit.md"
...
def main() -> int:
    ...
    manifest = load_json(BASELINE_DIR / "final65_focus_v3_manifest.json")
    eval_results = load_csv(BASELINE_DIR / "final_policy_results.csv")
    ...
    add("baseline60_retained", True, "RF h=60 60.31% baseline retained", severity="info")
    ...
    md = ["# VN30 Hourly 2015 - Final65 Focus v3 Audit", "",
    ...
    if selected_policies:
        md.extend(["## Selected Policy", "",
            markdown_table(["policy_id", "policy_type", "validation_accuracy", "validation_coverage", "validation_rows", "final_accuracy", "final_coverage", "final_rows"], selected_policies), ""])
