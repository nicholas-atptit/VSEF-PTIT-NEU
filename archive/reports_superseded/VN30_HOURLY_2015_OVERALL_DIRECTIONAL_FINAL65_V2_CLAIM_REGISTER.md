# VN30 Hourly 2015 - Overall Directional Final65 V2 Claim Register
...
### final65_overall_directional_v2
- **Claim**: *(pending)* Model achieves >=65% overall directional accuracy on full VN30 universe with 100% coverage using rolling validation selection.
- **Status**: NOT YET PASSED
- **Condition**: Must achieve >=65% pooled accuracy with 100% coverage on full final evaluation set.

## Failed Claims

### final65_directional_v1
- **Claim**: Various models/horizons achieve >=65% directional accuracy.
- **Status**: FAILED
- **Best result**: 59.70% (RF h=60, combined features)
- **Gap to 65%**: 5.30 percentage points

### final65_directional (earlier attempts)
- **Claim**: Various models/horizons achieve >=65% directional accuracy.
- **Status**: FAILED
