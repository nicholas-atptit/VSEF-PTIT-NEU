...
class QualitativeSystemParameters(BaseModel):
    """System parameters specific to qualitative LLM output."""

    applied_risk_tolerance: float = Field(..., le=0.70, description="Risk cap applied by the LLM")
    confidence_metrics: ConfidenceMetrics


class QualitativeAnalysis(BaseModel):
    """Phase 3 qualitative analysis output generated by the LLM."""

    analysis_status: str = Field(..., description="success or insufficient_data")
    sentiment: str = Field(..., description="positive, neutral, or negative")
    risk_factor: str = Field(..., description="high, medium, or low")
    reasoning: str = Field(..., description="Explanation of the reasoning.")
    system_parameters: QualitativeSystemParameters
    sources_used: list[str] = Field(..., description="List of RAG zones utilized")
